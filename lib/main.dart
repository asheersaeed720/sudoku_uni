    ...
    getPrefs().whenComplete(() {
      ...
      if (currentTheme == null) {
        if (MediaQuery.maybeOf(context)?.platformBrightness != null) {
          currentTheme =
              MediaQuery.of(context).platformBrightness == Brightness.light ? 'light' : 'dark';
        } else {
          currentTheme = 'dark';
        }
                ...
                onTap: () {
                  ...
                  Timer(
                      ...
                      () => showAnimatedDialog<void>(
                                  ...
                                  builder: (_) => AlertDifficultyState(currentDifficultyLevel!))
                              .whenComplete(() {
                ...
                onTap: () {
                  ...
                  Timer(
                      ...
                      () => showAnimatedDialog<void>(
                                  ...
                                  duration: const Duration(milliseconds: 350),
                                  context: outerContext,
                                  builder: (_) => AlertAccentColorsState(currentAccentColor!))
                              .whenComplete(() {
